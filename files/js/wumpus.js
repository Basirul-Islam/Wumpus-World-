class Wumpus {
    ...
    constructor() {
        this.worldData = new Array(10);
        this.worldVisited = new Array(10);
    ...
    reStart() {
        ...
        for (var x = 1; x <= 10; x++) {
            this.worldData[x] = new Array(10);
            this.worldVisited[x] = new Array(10);
        ...
        while (countPit < 5) {
            ...
            if (y < 10) this.worldData[x][y + 1].setBreeze();
            if (x > 1) this.worldData[x - 1][y].setBreeze();
            if (x < 10) this.worldData[x + 1][y].setBreeze();
            countPit++;
        }
        ...
        while (true) {
            ...
            if (y < 10) this.worldData[x][y + 1].setStench();
            if (x > 1) this.worldData[x - 1][y].setStench();
            if (x < 10) this.worldData[x + 1][y].setStench();
            break;
        }
    ...
    move() {
        ...
        if (this.worldData[this.x][this.y].isGold) {
            ...
            this.gameOver = true;
            $('#status').text('Gold Found! You Win');
            ...
            if (this.x != 10 && this.worldVisited[this.x + 1][this.y].pitChance < 90) {
                this.randomMoves = 0;
                return this.Moves.Right;
            } else if (this.y != 10 && this.worldVisited[this.x][this.y + 1].pitChance < 90) {
                this.randomMoves = 0;
                return this.Moves.Top;
            } else if (this.x != 1 && this.worldVisited[this.x - 1][this.y].pitChance < 90) {
                this.randomMoves = 0;
                return this.Moves.Left;
            } else if (this.y != 1 && this.worldVisited[this.x][this.y - 1].pitChance < 90) {
                this.randomMoves = 0;
            ...
            else if (this.x != 10 && this.worldData[this.x + 1][this.y].isVisited) {
                this.worldVisited[this.x + 1][this.y].visitedNum++;
                return this.Moves.Right;
            }
            // if up is safe, move there
            else if (this.y != 10 && this.worldData[this.x][this.y + 1].isVisited) {
                this.worldVisited[this.x][this.y + 1].visitedNum++;
            ...
            if (this.x != 10 && !this.worldData[this.x + 1][this.y].isVisited) {
                this.worldVisited[this.x + 1][this.y].visitedNum++;
                return this.Moves.Right;
            }
    ...
    areWeNearOfWumpus() {
        // Is wumpus up? Shoot
        if (this.y != 10 && this.worldVisited[this.x][this.y + 1].wumpusChance >= 60) {
            this.shootDirection = this.Moves.Up;
            return true;
        }
        // Is wumpus right? Shoot
        else if (this.x != 10 && this.worldVisited[this.x + 1][this.y].wumpusChance >= 60) {
            this.shootDirection = this.Moves.Right;
            return true;
        }
    ...
    PitWumpusPercentage(pit, wumpus) {
        ...
        //if up not visited, add 30% chance
        if (this.y != 10 && !this.worldData[this.x][this.y + 1].isVisited) {
            if (pit)
                this.worldVisited[this.x][this.y + 1].pitChance += 30;
